...
export const messagesReplies = {
    ...
    desc: {
        ...
        stickerDescription: '_А еще можно отправить стикер, и я пришлю его в виде файла и изображения/GIF!_',
        supDocExt:
    ...
    // Сообщения связанные со стикерами
    stickerFile: 'Стикер в виде файла',
    stickerImage: 'Стикер в виде изображения',
    stickerGif: 'Стикер в виде GIF',
    stickerError: 'Произошла ошибка при обработке стикера. Возможно, такой тип не поддерживаются.',
}
